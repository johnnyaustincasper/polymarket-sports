  ...
  return (
    <main className="auth-shell">
      <style>{`
        ...
        .auth-grid-bg { position: fixed; inset: 0; background-image: linear-gradient(rgba(166,255,63,0.04) 1px, transparent 1px), linear-gradient(90deg, rgba(166,255,63,0.04) 1px, transparent 1px); background-size: 48px 48px; }
        .auth-glow-bg { position: fixed; inset: 0; background: radial-gradient(ellipse 60% 60% at 50% 35%, rgba(166,255,63,0.15), transparent 72%); }
        .auth-card {
          position: relative;
          z-index: 1;
          width: min(100%, 460px);
          ...
          border-radius: 32px;
          border: 1px solid rgba(166,255,63,0.24);
          background: linear-gradient(135deg, rgba(8,12,6,0.98), rgba(0,0,0,0.92));
          box-shadow: 0 0 70px rgba(166,255,63,0.12), 0 24px 90px rgba(0,0,0,0.82);
          padding: 28px;
          box-sizing: border-box;
          overflow-y: auto;
        ...
        .auth-logo { width: 118px; height: 118px; border-radius: 30px; margin: 0 auto 16px; overflow: hidden; border: 1px solid rgba(166,255,63,0.35); box-shadow: 0 0 42px rgba(166,255,63,0.18); }
        .auth-logo img { width: 100%; height: 100%; object-fit: cover; display: block; }
        .auth-eyebrow { color: #a6ff3f; font-weight: 900; font-size: 11px; letter-spacing: 0.2em; text-transform: uppercase; margin: 0; }
        ...
        @media (max-width: 480px) {
          ...
          .auth-card {
            ...
            border-radius: 24px;
            padding: 14px;
            box-shadow: 0 0 46px rgba(166,255,63,0.10), 0 18px 54px rgba(0,0,0,0.72);
          }
