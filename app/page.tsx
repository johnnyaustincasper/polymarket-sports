          ...
          <div>
            <div className="flex items-center gap-3 mb-1" style={{ flexWrap: 'wrap' }}>
              ...
              <h1 style={{ fontSize: isMobile ? 21 : 26, fontWeight: 900, letterSpacing: '-0.03em', color: C.textPrimary }}>
                {sport === 'nba' ? 'NBA' : sport === 'ncaab' ? 'NCAAB' : sport === 'nfl' ? 'NFL' : sport === 'ncaaf' ? 'NCAAF' : sport === 'mlb' ? 'MLB' : 'UFC'}
                <span style={{ color: sport === 'ufc' ? UFC_RED : sport === 'nfl' || sport === 'ncaaf' ? C.green : sport === 'mlb' ? MLB_ORANGE : C.cyan, textShadow: `0 0 20px ${sport === 'ufc' ? UFC_RED : sport === 'nfl' || sport === 'ncaaf' ? C.green : sport === 'mlb' ? MLB_ORANGE : C.cyan}55` }}>{sport === 'ufc' ? ' FIGHTS' : sport === 'nfl' || sport === 'ncaaf' ? ' GRIDIRON' : sport === 'mlb' ? ' DIAMOND' : ' LINES'}</span>
              </h1>
            ...
            <p style={{ color: C.textSecondary, fontSize: isMobile ? 11 : 12, letterSpacing: '0.06em', display: 'flex', alignItems: 'center', gap: 6 }}>
              <span>Polymarket · DraftKings · NBA/NFL/MLB misprice board</span>
              {lastUpdatedLabel && (
                <span style={{
                  display: 'inline-flex', alignItems: 'center', gap: 4,
